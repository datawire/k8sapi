module github.com/datawire/k8sapi
...
replace github.com/datawire/argo-rollouts-go-client => github.com/thallgren/argo-rollouts-go-client v0.0.0-20240820044539-2da0ddbd08bc
